...
//condición lógica if, operador ternario ? :
// (condicion logica)? (logica a ejecutar si cumple la condicion logica): (el codigo que ejecuto si no se cumple la condicion logica)
